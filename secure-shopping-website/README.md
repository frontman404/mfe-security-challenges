...
This directory contains the secure implementation of a shopping website built with a micro frontend architecture.

## What this app demonstrates

- modular microfrontends for `auth`, `cart`, `order`, `products`, and `container`
- secure communication patterns between modules
- improved handling of user input, authentication, and state sharing compared to the vulnerable version
...
This version is intended for study and comparison only. Use it as a reference implementation when discussing secure design decisions.
